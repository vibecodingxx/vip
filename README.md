<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Capriola&size=40&duration=4000&pause=450&color=F70069&background=FFFFAA00&center=true&random=false&width=600&height=100&lines=XXX+VPN+AUTOSCRIPT+!;Explore+the+world+of+features!" alt="Typing SVG" />
  </a>
</p>
...
### INSTALL SCRIPT
<pre><code>apt update -y && apt install -y wget curl jq && apt install golang-go && wget -q https://raw.githubusercontent.com/vibecodingxx/vip/main/Install.sh && chmod +x Install.sh && ./Install.sh 
</code></pre>
